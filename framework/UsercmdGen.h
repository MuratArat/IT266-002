...
const int IMPULSE_23			= 23;			// heal spell
const int IMPULSE_24			= 24;			// dmg up spell
const int IMPULSE_25			= 25;			// double jump spell
const int IMPULSE_26			= 26;			// armour up spell
const int IMPULSE_27			= 27;			// fireball
